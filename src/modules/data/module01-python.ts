  ...
  "chapters": [
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch1-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Write a Python program that prints your name, your age, and your favourite programming language on three separate lines.\n\n**Hint:** *Use three separate print() statements, one for each line. Each string goes inside quotes within the print() parentheses.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
        },
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch2-booleans-bool",
          "title": "Booleans (bool)",
          "content": "Booleans represent one of two values: True or False. They are used in conditions, comparisons, and logical operations. An interesting Python detail: bool is actually a subclass of int, where True is equivalent to 1 and False is equivalent to 0. This means you can use booleans in arithmetic.\n\n\n\n```python\nis_active = True\n\nis_deleted = False\n\nprint(True + True) # 2\n\nprint(type(False)) # \<class 'bool'>\n```\n\nSince True equals 1 and False equals 0, the expression True + True is effectively 1 + 1, which gives 2. This is occasionally useful \u2014 for example, you can count how many conditions are True in a list by using sum() on a list of booleans.",
          "taskDescription": "Read the documentation and experiment with the code examples in the editor.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        {
          "id": "ch3-conditional-statements",
          "title": "Conditional Statements",
          "content": "Conditional statements let your program make decisions based on whether a condition is true or false. Python uses the keywords if, elif (short for \"else if\"), and else.",
          "taskDescription": "Read the documentation and experiment with the code examples in the editor.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
        ...
        },
        {
          "id": "ch3-loops",
          "title": "Loops",
          "content": "Loops let you repeat a block of code multiple times. Python has two types of loops: for (when you know the number of iterations or are iterating over a collection) and while (when you want to repeat until a condition becomes false).",
          "taskDescription": "Read the documentation and experiment with the code examples in the editor.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch4-parameters-and-arguments",
          "title": "Parameters and Arguments",
          "content": "Parameters are the variable names listed in the function's definition (the blueprint). Arguments are the actual values you pass when calling the function. While these terms are often used interchangeably in casual conversation, understanding the distinction helps when reading documentation.",
          "taskDescription": "Read the documentation and experiment with the code examples in the editor.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
        ...
        {
          "id": "ch4-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Write a function is_palindrome(text) that returns True if the given string reads the same forwards and backwards (ignore case). Test it with \\\"Racecar\\\" and \\\"Python\\\".\n\n**Hint:** *Convert to lowercase with .lower() to make the comparison case-insensitive, then compare the string to its reverse using slicing: text[::-1] reverses a string.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch5-essential-string-methods",
          "title": "Essential String Methods",
          "content": "Python strings come with dozens of built-in methods. Here are the most important ones, organized by category.",
          "taskDescription": "Read the documentation and experiment with the code examples in the editor.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch6-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Write a function that takes two lists and returns a list of elements common to both, without duplicates. First write it with loops, then refactor using sets.\n\n**Hint:** *Loop approach: iterate through one list, check if each item is in the other list AND not already in your result list. Set approach: convert both lists to sets and use the & (intersection) operator.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch7-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Write a program that reads a text file, counts the number of lines, words, and characters, and prints the results (similar to the Unix wc command).\n\n**Hint:** *Open the file and read all lines. Count lines with len(lines), words by splitting each line and summing the lengths, characters by summing len(line) for each line.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch8-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Write a function safe_divide(a, b) that returns a/b but handles ZeroDivisionError and TypeError gracefully with informative messages. Return None on error.\n\n**Hint:** *Use try-except with two except clauses. ZeroDivisionError catches division by zero. TypeError catches cases like dividing a string by a number.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch9-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Create a module called geometry.py with functions area_circle(r), area_rectangle(l, w), and area_triangle(b, h). Then import and use them from a main.py file.\n\n**Hint:** *Use math.pi for the circle. Formulas: circle = \u03c0r\u00b2, rectangle = l\u00d7w, triangle = \u00bdb\u00d7h. In main.py, use from geometry import \... to bring in the functions.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
    ...
    },
    {
      ...
      "subModules": [
        ...
        {
          "id": "ch10-practice-exercises",
          "title": "Practice Exercises",
          "content": "**Exercise 1:** Create a Student class with attributes: name, roll_number, grades (list of floats). Add methods: add_grade(grade), average_grade(), and highest_grade(). Implement \_\_str\_\_ to display student info.\n\n**Hint:** *Initialize grades as an empty list in \_\_init\_\_. add_grade validates and appends. average_grade uses sum()/len(). highest_grade uses max(). \_\_str\_\_ formats a readable string.*",
          "taskDescription": "Complete the exercises listed in the documentation. Use the code editor to test your solutions.",
          "initialCode": "# Experiment here\n",
          "testScript": "",
          "completed": false
